export const msgConstructor = (inputArr: any) => {
  ...
  - "totalScore": which returns us back the total overall score based on how many matching values are present. If there are no matching values, return 0. If everything matches, return 5.
